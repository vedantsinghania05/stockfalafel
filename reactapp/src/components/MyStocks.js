...
import {
  Container, Card, CardBody, Button, Input, Form, Spinner, Row, Col, Table, Toast, ToastHeader, InputGroup, Dropdown, DropdownItem,
  DropdownMenu, DropdownToggle, ButtonGroup, InputGroupAddon
} from 'reactstrap'
...
class MyStocks extends Component {
  constructor() {
    super();
    this.state = {
      result: '', userCompanyList: [], showGraph: false, selectedTicker: undefined, stockChartXValues: [], stockChartYClose: [],
